		...
		<head>
			...
			<script language="JavaScript"><![CDATA[
			   ...
			   function change(details_id)
			   {
			      ...
			      {
			         document.getElementById(details_id+"_image").src = "../res/collapse.png";
			         expand(details_id);
			      }
			      else
			      {
			         document.getElementById(details_id+"_image").src = "../res/expand.png";
			         collapse(details_id);
			      } 
                           }
			]]></script>
...
<xsl:template name="pageHeader">
	...
	<table width="100%">
		<tr>
			...
			<td align="right">Designed for use with <a href="http://jmeter.apache.org/">JMeter by DavisXie</a> and <a href="http://ant.apache.org">Ant</a>.</td>
		</tr>
	</table>
	<hr size="1" />
</xsl:template>
			...
			<tr valign="top">
				...
				<td align="center">
				   <a href="">
				      ...
				      <img src="../res/expand.png" alt="expand/collapse"><xsl:attribute name="id"><xsl:text/>page_details_<xsl:value-of select="position()" />_image</xsl:attribute></img>				      
				   </a>
				</td>
			</tr>
